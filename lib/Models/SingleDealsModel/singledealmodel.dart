class SingleDealsModel {
  ...
  SingleDealsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    desc = json['desc'];
    price = json['price'];
    ...
    if (json['DealImages'] != null) {
      ...
      json['DealImages'].forEach((v) {
        dealImages!.add(new DealImages.fromJson(v));
      });
    }
...
class DealImages {
  ...
  DealImages({this.dealId, this.sorting, this.imagePath, this.id});

  DealImages.fromJson(Map<String, dynamic> json) {
    dealId = json['dealId'];
